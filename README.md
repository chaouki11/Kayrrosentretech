...
- 🎯 Entry points to execute your program using `python -m <kayrrentretientech>` or `$ kayrrentretientech` with basic CLI argument parsing.
...
---
# kayrrentretientech Flask Application

Awesome kayrrentretientech created by chaouki11
...
```bash
git clone https://github.com/chaouki11/KayrrEntretienTech kayrrentretientech
cd kayrrentretientech
make install
```
...
```bash
pip install kayrrentretientech
```
...
```bash
kayrrentretientech create-db   # run once
kayrrentretientech populate-db  # run once (optional)
kayrrentretientech add-user -u admin -p 1234  # ads a user
kayrrentretientech run
```
